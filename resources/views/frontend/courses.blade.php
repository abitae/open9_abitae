            ...
            <div class="row">
                <div class="col col-lg-9">
                    <div class="course_card list_layout">
                        <div class="item_image"><a href="course_details.html" data-cursor-text="View"><img
                                    src="collab/assets/images/course/course_image_1.jpg"
                        ...
                        <div class="item_content">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <div class="item_price"><span class="sale_price">$19.99</span> <del
                    ...
                    <div class="course_card list_layout">
                        <div class="item_image"><a href="course_details.html" data-cursor-text="View"><img
                                    src="collab/assets/images/course/course_image_2.jpg"
                                    alt="Collab – Online Learning Platform"></a></div>
                        <div class="item_content">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <ul class="item_category_list unordered_list">
                                ...
                                <div class="item_price"><span class="sale_price">$14.99</span></div>
                            </div>
                            <ul class="meta_info_list unordered_list">
                                <li><i class="fas fa-chart-bar"></i> <span>Beginner</span></li>
                                <li><i class="fas fa-clock"></i> <span>120 Hours</span></li>
                            ...
                            <h3 class="item_title"><a href="course_details.html">Programming Foundations with
                                    JavaScript, HTML and CSS</a></h3><a class="btn_unfill"
                                href="course_details.html"><span class="btn_text">View Course</span> <span
                                    class="btn_icon"><i class="fas fa-long-arrow-right"></i> <i
                                        class="fas fa-long-arrow-right"></i></span></a>
                        </div>
                    ...
                    <div class="course_card list_layout">
                        <div class="item_image"><a href="course_details.html" data-cursor-text="View"><img
                                    src="collab/assets/images/course/course_image_3.jpg"
                                    alt="Collab – Online Learning Platform"></a></div>
                        <div class="item_content">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <ul class="item_category_list unordered_list">
                                ...
                                <div class="item_price"><span class="sale_price">$15.69</span></div>
                            </div>
                            <ul class="meta_info_list unordered_list">
                                <li><i class="fas fa-chart-bar"></i> <span>Beginner</span></li>
                                <li><i class="fas fa-clock"></i> <span>120 Hours</span></li>
                    ...
                    <div class="course_card list_layout">
                        ...
                        <div class="item_content">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <ul class="item_category_list unordered_list">
                                    <li><a href="#!">bissines</a></li>
                                </ul>
                                <div class="item_price"><span class="sale_price">$29.99</span></div>
                            </div>
                            <ul class="meta_info_list unordered_list">
                                <li><i class="fas fa-chart-bar"></i> <span>Beginner</span></li>
                                <li><i class="fas fa-clock"></i> <span>120 Hours</span></li>
                    ...
                    <div class="course_card list_layout">
                        ...
                        <div class="item_content">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <div class="item_price"><span class="sale_price">$12.99</span> <del
                                        class="remove_price">$19.99</del></div>
                            </div>
                            <ul class="meta_info_list unordered_list">
                                <li><i class="fas fa-chart-bar"></i> <span>Beginner</span></li>
                                <li><i class="fas fa-clock"></i> <span>120 Hours</span></li>
                            ...
                            <h3 class="item_title"><a href="course_details.html">Java Programming: Principles of
                                    Software Design</a></h3><a class="btn_unfill" href="course_details.html"><span
                                    class="btn_text">View Course</span> <span class="btn_icon"><i
                                        class="fas fa-long-arrow-right"></i> <i
                                        class="fas fa-long-arrow-right"></i></span></a>
                        </div>
                ...
                <div class="col col-lg-3">
                    <aside class="sidebar filter_offcanvas">
                                ...
                                <div class="card card-body">
                                    <div class="checkbox_item"><input id="checkbox_lisa_baker" type="checkbox">
                                        <label for="checkbox_lisa_baker"><span>Lisa
                                                Baker</span><span>(18)</span></label>
                                    </div>
                                    <div class="checkbox_item"><input id="checkbox_brandy_carlson" type="checkbox">
                                        <label for="checkbox_brandy_carlson"><span>Brandy
                                                Carlson</span><span>(10)</span></label></div>
                                    <div class="checkbox_item"><input id="checkbox_kevin_taylor" type="checkbox">
                                        <label for="checkbox_kevin_taylor"><span>Kevin
                                                Taylor</span><span>(11)</span></label></div>
                                    <div class="checkbox_item"><input id="checkbox_catherine_parker" type="checkbox">
                        ...
                        <div class="widget">
                            <div class="widget_title" role="button" data-bs-toggle="collapse"
                                data-bs-target="#collapse_price" aria-expanded="true" aria-controls="collapse_price">
                                Price</div>
                        ...
                        <div class="widget">
                            <div class="widget_title" role="button" data-bs-toggle="collapse"
                                data-bs-target="#collapse_level" aria-expanded="true" aria-controls="collapse_level">
                                Level</div>
                                ...
                                <div class="card card-body">
                                    <div class="checkbox_item"><input id="checkbox_all_levels" type="checkbox">
                                        <label for="checkbox_all_levels"><span>All
                                                Levels</span><span>(18)</span></label>
                                    </div>
                                    ...
                                    <div class="checkbox_item"><input id="checkbox_intermediate" type="checkbox">
                                        <label
