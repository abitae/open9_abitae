<div class="bg-white dark:bg-neutral-800 rounded-lg p-6">
    <form wire:submit.prevent="save" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                <flux:label for="image" class="text-gray-700 dark:text-gray-300">Image</flux:label>
                <flux:input type="file" wire:model="image" id="image" accept="image/*"
                    class="w-full" />
            ...
            <div>
                ...
                <flux:input type="file" wire:model="video" id="video" accept="video/*"
                    class="w-full" />
                <flux:error name="video"></flux:error>
            </div>
        </div>
